...
class TwoStepVerification extends React.Component {
  ...
  render() {
    return (
      <Auxillary>
        <header className="col-12 fixed-top mobile__view__starred__Messages__Header py-2" id="mobile__twoStepVerification__head">
                ...
                <div className="row mx-0">
                  <div className="archievedChatSection w-100">
                    ...
                    <div className="no-archieved-chats text-center">
                      For added security, enable two-step verification, which will required a PIN when registering your phone number with
                      WhatsApp again
                    </div>
                  </div>
                </div>
        ...
        <MainBottomDrawer onOpen={this.setStep1True} open={this.state.step1}>
          <TwoStepVerificationStep1 componentWithoutSearchBar={this.props.componentWithoutSearchBar} closeDrawer={this.setStep1False} />
        </MainBottomDrawer>
      </Auxillary>
    );
  }
