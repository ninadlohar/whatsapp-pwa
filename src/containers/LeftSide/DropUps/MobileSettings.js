      ...
      <div>
        ...
        <div className="col-12 px-0">
          <div className="row mx-0">
            ...
            <div className="col-12 py-3 d-flex">
              <div className="d-flex align-items-center pl-3 pr-4">
                <img src={require("../../../assets/svg/notification.svg")} alt="sender-images" height="18" width="18" />
              </div>
              <div className="d-flex align-items-center w-100">
                <div>
            ...
            <div className="col-12 py-3 d-flex">
              <div className="d-flex align-items-center pl-3 pr-4">
                <img src={require("../../../assets/svg/information.svg")} alt="sender-images" height="18" width="18" />
              </div>
              <div className="d-flex align-items-center w-100">
                <div>
