            ...
            <div className="col-12 px-0 leftSide__log__of__chats leftSlider__profile__section">
              <div className="row mx-0">
                <div className="archievedChatSection w-100">
                  ...
                  <div className="no-archieved-chats text-center">For added security, enable two-step verification, which will required a PIN when registering your phone number with WhatsApp again</div>
                </div>
              </div>
            </div>
          </div>
